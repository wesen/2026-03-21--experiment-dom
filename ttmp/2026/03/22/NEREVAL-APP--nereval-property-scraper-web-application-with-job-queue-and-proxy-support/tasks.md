...
- [x] Enhance Landlords tab: fuzzy name grouping, total portfolio value, linked properties
- [x] Add multi-unit analysis: filter by design type, sort by unit count, assessment per unit
- [x] Combine browser.mjs + new endpoints into single app.mjs
- [x] Test full flow: configure proxy, start job, monitor progress, browse results
